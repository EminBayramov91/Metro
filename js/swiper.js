if (function (e, t) {
    ...
    const J = [function ({swiper: e, extendParams: t, on: s}) {
        ...
        function r(t) {
            const {slidesPerView: s, slidesPerGroup: a, centeredSlides: r} = e.params, {addSlidesBefore: n, addSlidesAfter: l} = e.params.virtual, {from: o, to: d, slides: p, slidesGrid: c, offset: u} = e.virtual;
        ...
        function p() {
            ...
            if ("fraction" === s.type && (p.find(q(s.currentClass)).text(s.formatFractionCurrent(c + 1)), p.find(q(s.totalClass)).text(s.formatFractionTotal(u))), "progressbar" === s.type) {
                let t;
                t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
                const a = (c + 1) / u;
                let i = 1, r = 1;
                "horizontal" === t ? i = a : r = a, p.find(q(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(e.params.speed)
            }
        ...
        function w() {
            ...
            })), e.navigation && e.navigation.$nextEl && (m = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (f = e.navigation.$prevEl), m && m.length && v(m, r, t.nextSlideMessage), f && f.length && v(f, r, t.prevSlideMessage), g() && e.pagination.$el.on("keydown", q(e.params.pagination.bulletClass), h)
        }
        ...
        s("beforeInit", (() => {
            ...
            e.params.a11y.enabled && function () {
                let t, s;
                a && a.length > 0 && a.remove(), e.navigation && e.navigation.$nextEl && (t = e.navigation.$nextEl), e.navigation && e.navigation.$prevEl && (s = e.navigation.$prevEl), t && t.off("keydown", h), s && s.off("keydown", h), g() && e.pagination.$el.off("keydown", q(e.params.pagination.bulletClass), h)
            }()
        }))
    }, function ({swiper: e, extendParams: t, on: s}) {
    ...
    return H.use(J), H
})), null !== document.querySelector(".home-swiper")) {
...
if (null !== document.querySelector(".home-swiper")) {
    new Swiper(".mySwiperTop", {
        ...
        slidesPerGroup: 1,
        clickable: !0,
        breakpoints: {1e3: {slidesPerView: 8}, 600: {slidesPerView: 5}},
        navigation: {nextEl: ".swiper-button-next1", prevEl: ".swiper-button-prev1"}
    })
}
if (null !== document.querySelector(".philosophy-swiper")) {
    new Swiper(".philosophy-swiper", {
        direction: "vertical",
        loop: !0,
...
if (null !== document.querySelector(".philosophy-intro-swiper")) {
    new Swiper(".philosophy-intro-swiper", {
        direction: "vertical",
        loop: !0,
...
if (null !== document.querySelector(".philosophy-expo-swiper")) {
    new Swiper(".philosophy-expo-swiper", {
        direction: "vertical",
        loop: !0,
        pagination: {el: ".swiper-pagination", clickable: !0},
        navigation: {nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev"},
...
if (null !== document.querySelector(".mySwiper5")) {
