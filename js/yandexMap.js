(function ymapsInit(e) {
    ...
    t.modules = new o({
        dependenciesContext: t, initialBudleName: t.env.preload.bundle, fetchBundle: function (e) {
            ...
            o.src = t.env.bundles.BASE + t.env.bundles[e], o.setAttribute("data-ymaps-api-ns", r), o.setAttribute("data-ymaps-api-version", "2.1.79"), o.async = !0;
            var i = t.vow.defer();
    ...
    "vectorVersion": "5.20.1",
    "vectorVersionTimestamp": 1642816344648,
    "cacheVersion": null,
    "type": "production",
    "flags": [],
    "server": {
        ...
        "path": "build/release",
        "params": {"amp;apikey": "", "mode": "release", "ns": "ymaps", "csp": null}
    },
    ...
    "layers": {
        "map": {
            "version": "22.01.19-1-b211218133230",
            "scaled": true,
        ...
        "stv": {"version": "2022.01.21.19.01-1_22.01.20-1-10222"},
        "sta": {"version": "2022.01.21.19.01-1_22.01.20-1-10222"},
        "trf": {"version": "1642816320", "scaled": true},
    ...
    "geolocation": {
        ...
        "span": {"longitude": 0.291817, "latitude": 0.1808}
    },
    "token": "bb4871f979d4e0b0948f1744f46f1987",
    "distribution": {},
    "version": "2.1.79",
    "majorVersion": "2.1",
    ...
    "bundles": {
        "panoramas": "/release/panoramas-0c185fde5cfe1430e95b277aaa8e9a9977944166.js",
        "full": "/release/full-d1de67c44ff77d445058e8457ca6578da7094d3a.js",
        "BASE": "https://yastatic.net/s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-29/build"
    }
}, null)

// yandex map
if (document.querySelector('.div-map') !== undefined || null) {
